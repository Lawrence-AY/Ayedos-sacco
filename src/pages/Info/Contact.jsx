...
function Contact({ onNavigate }) {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: HiPhone,
      title: "Phone",
      lines: ["+254 733 556 617"],
    },
    {
      icon: HiEnvelope,
      title: "Email",
      lines: ["info@cowrie.io"],
    },
    {
      icon: HiClock,
  ...
  const quickLinks = [
    { label: "24h Response Time", color: "bg-accent text-white" },
    { label: "24/7 Support", color: "bg-accent text-white" },
  ];
      ...
      <div className={`flex-1 ${isDark ? "bg-black" : "bg-gray-50"}`}>
        <div className="max-w-6xl mx-auto px-4 py-12">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p
              className={`text-lg ${isDark ? "text-gray-300" : "text-slate-600"}`}
            >
              Have questions about Ayedos SACCO? Need support with your account?
          ...
          <div className="grid lg:grid-cols-2 gap-12 mb-16">
            <div
              className={`rounded-3xl border p-8 shadow-xl transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 ${
                isDark
            ...
            <div className="space-y-6">
                      ...
                      <div key={index} className="flex items-start gap-4 group">
                        <div
                          className={`w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0 transition-all duration-300 group-hover:scale-110 ${
                            isDark ? "bg-[#8cc63f]/20" : "bg-[#8cc63f]/10"
                          }`}
                        >
                          <Icon
                            className="w-6 h-6"
              ...
              >
                ...
                <div
                  className={`mb-4 ${isDark ? "text-gray-300" : "text-slate-600"}`}
                >
                  We respond to all inquiries within 24 hours during business
                  days. For urgent technical issues, our support team is
                  available 24/7.
                </div>
          ...
          <div
            className={`rounded-3xl p-10 text-center transition-all duration-300 ${
              isDark
          ...
          >
            ...
            >
              Check out our comprehensive FAQ section or browse our guides for
              quick answers
            </div>
