      ...
      <div className="grid md:grid-cols-4 gap-8 max-w-6xl mx-auto px-6">
        ...
        <div className="md:col-span-3  text-white grid grid-cols-2 md:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <a href="/http://192.168.56.1:5173/register" onClick={(e) => handleRouteClick(e, 'register')} className="block py-1">Get Started</a>
            <a href="/http://192.168.56.1:5173/login" onClick={(e) => handleRouteClick(e, 'login')} className="block py-1">Log in</a>
          </div>
